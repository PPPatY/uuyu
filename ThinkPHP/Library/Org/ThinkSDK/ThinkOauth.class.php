...
abstract class ThinkOauth{
	...
	public function getRequestCodeURL(){
		...
		if(session('for_third') == C(PC_SET_DOMAIM)){
			if ($_REQUEST['gid']) {
				$params['redirect_uri'] = 'http://'.session('for_third')."/mobile.php?s=/Subscriber/callback/type/qq/sta/".$_SERVER['HTTP_HOST'].'/pid/'.session('union_host')['union_id'].'/gid/'.$_REQUEST['gid'];
			}else{
				$params['redirect_uri'] = 'http://'.session('for_third')."/mobile.php?s=/Subscriber/callback/type/qq/sta/".$_SERVER['HTTP_HOST'].'/pid/'.session('union_host')['union_id'];
			}
		}else{
