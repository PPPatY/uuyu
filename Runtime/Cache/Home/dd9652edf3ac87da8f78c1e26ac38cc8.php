...
<html>
    ...
    <link href="/Public/Home/css/20170913/about.css" rel="stylesheet">
    ...
    <div class="page-article index-about-article">
        <div class="inner">
          <div class="about">
            <div class="abouttit"><img src="/Public/Home/images/20170913/abouttit.png"></div>
            <div class="aboutcon">
    ...
    <script>highlight_subnav('<?php echo U("Index/about");?>');</script>
