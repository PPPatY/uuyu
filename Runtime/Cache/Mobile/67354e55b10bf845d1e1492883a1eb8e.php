  ...
  display: none;
    ...
    <header class="header">
      <section class="wrap">
        ...
        <div class="caption"><span class="table"><span class="table-cell">我的礼包</span></span></div>
      </section>
    </header>
    ...
    <section class="trunker">
      ...
      <section class="inner">
        <section class="contain">
          <div class="list gift-list">
            
            <div class="empty">
              <img src="/Public/Mobile/images/blank_gift.png" class="empty-icon">
              <p class="empty-text">暂无礼包</p>
            </div>
            <?php if(!empty($giftlist)): ?><div class="hot-gift">
              <div class="hot-gift-title"><span>推荐礼包</span><a href="<?php echo U('Gift/index');?>" class="more"><img src="/Public/Mobile/images/ma_more.png" class="icon-right"></a></div>
              <ul class="list text-pic-list">
              <?php if(is_array($giftlist)): $i = 0; $__LIST__ = $giftlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gift): $mod = ($i % 2 );++$i;?><li class="clearfix">
                  <div class="item clearfix">
                    <a href="<?php echo ($gift["play_detail_url"]); ?>" class="iconbox"><span class="font table"><span class="table-cell"><?php echo C('BITMAP');?></span></span><img src="<?php echo ($gift["icon"]); ?>" class="icon"></a>
                    <div class="butnbox"><span class="table"><span class="table-cell"><a href="<?php echo U('Gift/giftdetail',array('gift_id'=>$gift['gift_id']));?>" class="butn">去领取</a></span></span></div>
                    <div class="textbox">
                      <a href="<?php echo U('Gift/giftdetail',array('gift_id'=>$gift['gift_id']));?>" class="title">《<?php echo ($gift['game_name']); ?>》<?php echo ($gift["giftbag_name"]); ?></a>
                      <div class="surplusbox"><span class="surplus"><i style="width:<?php echo round($gift['novice_surplus']/$gift['novice_all']*100,2);?>%"></i></span><span class="number">剩余<i><?php echo round($gift['novice_surplus']/$gift['novice_all']*100,2);?>%</i></span></div>
