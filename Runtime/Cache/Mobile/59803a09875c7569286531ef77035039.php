              ...
              <div class="play-scroll">
                <div id="hot-game-slide" class="swiper-container">
                  <ul class="swiper-wrapper">
                    ...
                    <li class="swiper-slide">
                      <div class="item">
                        <img class="game-bg-p" src="/Public/Mobile/images/index-game-icon-p-2.png" alt="">
                        <a href="www.baidu.com" >
                          <img src="/Public/Mobile/images/index-game-icon-p-2.png" class="icon" alt="">
                          <span class="game-title">决战沙城</span>
                          <span class="game-introduce">万人同屏战沙城</span>
                        </a>
                        <a class="began-game" href="www.mi.com">开始</a>
                    ...
                    <li class="swiper-slide">
                      <div class="item">
                        <img class="game-bg-p" src="/Public/Mobile/images/index-game-icon-p-3.png" alt="">
                        <a href="www.baidu.com" >
                          <img src="/Public/Mobile/images/index-game-icon-p-3.png" class="icon" alt="">
                          <span class="game-title">决战沙城</span>
                          <span class="game-introduce">万人同屏战沙城</span>
                        </a>
                        <a class="began-game" href="www.mi.com">开始</a>
                    ...
                    <li class="swiper-slide">
                      <div class="item">
                        <img class="game-bg-p" src="/Public/Mobile/images/index-game-icon-p.png" alt="">
                        <a href="www.baidu.com" >
                          <img src="/Public/Mobile/images/index-game-icon-p.png" class="icon" alt="">
                          <span class="game-title">决战沙城</span>
                          <span class="game-introduce">万人同屏战飒飒大苏打阿萨沙城</span>
                        </a>
                        <a class="began-game" href="www.mi.com">开始</a>
                      </div>
                    </li> -->
            ...
            if (hotGameData.status == 0) {
              ...
              if (!jQuery.isArray(nndata)) {
                $.each(nndata, function(i, e){
                  nnnum = i;
                  hotGameContent += '<li class="swiper-slide"><div class="item"><img class="game-bg-p" src="'+e.icon+'" alt=""><a href="'+e.play_detail_url+'" ><img src="'+e.icon+'" class="icon" alt=""><span class="game-title">'+e.game_name+'</span><span class="game-introduce">'+e.features+'</span></a><a class="began-game" href="'+e.play_url+'">开始</a></div></li>';
                })
              } else {
                nnnum = nndata.length;
                for(var i = 0; i < nndata.length; i++){
                  hotGameContent += '<li class="swiper-slide"><div class="item"><img class="game-bg-p" src="'+nndata[i].icon+'" alt=""><a href="'+nndata[i].play_detail_url+'" ><img src="'+nndata[i].icon+'" class="icon" alt=""><span class="game-title">'+nndata[i].game_name+'</span><span class="game-introduce">'+nndata[i].features+'</span></a><a class="began-game" href="'+nndata[i].play_url+'">开始</a></div></li>';
                }
              }
              $('#hot-game-slide ul').append(hotGameContent);
