<?php if (!defined('THINK_PATH')) exit();?><div class="popplog"></div>

<script src="/Public/static/layer/layer.js"></script>
<script>
    loginurl = "<?php echo U('Subscriber/login');?>";
    zhuceurl = "<?php echo U('Subscriber/register');?>";
    ykzhuceurl = "<?php echo U('Subscriber/ykregister');?>";
    ...
    signingamepurl="<?php echo U('Subscriber/siginingame');?>";
    thirdloginurl = "<?php echo U('Subscriber/thirdlogin');?>";
    thirdprologinurl = "<?php echo U('TuiRegister/thirdlogin');?>";
    ...
    $(function() {
      ...
      $('.jslogin').click(function() {
          ...
          // 登录注册弹窗
          popplog.addClass('pop-login').open('','<div class="lrbox"><a href="javascript:;" class="pop-close"></a><ul class="pop-tab jspoptab pop-clear"><li class="active"><a href="javascript:;" class="tab-butn">登录</a></li><li><a href="javascript:;" class="tab-butn">注册</a></li></ul><div class="pop-pan jspoppan"><div class="pan-item jspopitem"><form action=""><div class="pop-content"><div class="pop-table"><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_name.png" class="icon icon-user"></div><div class="pop-cell"><div class="pop-input"><input type="text" name="" id="lblTagIdUserName" class="txt" placeholder="手机号/用户名"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i></span></div></div><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_password.png" class="icon icon-lock"></div><div class="pop-cell"><div class="pop-input"><input type="password" name="" id="lblTagIdUserPwd" class="txt" placeholder="请输入登录密码"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i><i class="icon icon-eye jseye"></i></span></div></div></div><div class="pop-error error">用户名不存在</div></div><div class="pop-butn-box"><input type="button" class="butn lrbutn jssubbutn" id="blTagIdLoginBtn" value="登录"></div><div class="pop-link-box pop-clear"><span class="forgetbox"><a href="javascript:;" class="jspopforget">忘记密码？</a></span> <span class="temporary"><a href="javascript:;" class="jspoptemporary">游客登录<img src="/Public/Mobile/images/game_classify_selected.png" class="icon-right-pic"></a></span></div></form><div class="thirdlogin"><div class="thirdlogin-title"><span>第三方登录</span></div><div class="thirdlogin-content pop-clear">'+$('.loginbutdiv').html()+'</div></div></div><!-- ==============分割线============ --><div class="pan-item jspopitem"><form action=""><div class="pop-content"><div class="pop-table"><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_name.png" class="icon icon-user"></div><div class="pop-cell"><div class="pop-input"><input type="text" name="" style="width:120%;" id="zblTagIdUserName" class="txt account" placeholder="手机号/用户名(字母开头6-15位)"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i></span></div></div><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_code.png" class="icon icon-user"></div><div class="pop-cell verification"><div class="pop-input"><input type="text" id="zblTagIdPicCodeInput" name="" class="txt" placeholder="请输入验证码"></div><span class="pop-iconbox pop-clear" id="verify"><div class="pop-table"><div class="pop-cell"><a href="javascript:;" class="pop-code smcode jsverify">获取验证码</a><a href="javascript:;" class="pop-code pcode jschange"><img src="<?php echo U("Subscriber/verify");?>"></a></div></div></span></div></div><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_password.png" class="icon icon-lock"></div><div class="pop-cell"><div class="pop-input"><input type="password" id="zblTagIdUserPwd" name="" class="txt" placeholder="6-15位字母或数字"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i><i class="icon icon-eye jseye"></i></span></div></div><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_password.png" class="icon icon-lock"></div><div class="pop-cell"><div class="pop-input"><input type="password" id="zblTagIdConfirmUserPwd" name="" class="txt" placeholder="确认密码"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i><i class="icon icon-eye jseye"></i></span></div></div></div><div class="pop-error error">前后密码一致</div></div><div class="pop-butn-box"><input type="button" id="blTagIdSignupBtn" class="butn lrbutn jssubbutn" value="注册"></div><div class="pop-argee-box"><label><input type="checkbox" class="checkbox jscheckbox on"><i class="icon"></i><span>我已阅读并同意<a href="<?php echo U("Subscriber/user_argeement");?>">《用户注册协议》</a></span></label></div></form></div></div></div>');
        ...
        $('.account').keyup(function() {
          ...
          if (val) {
            ...
            if (/^[1a-zA-z]$/.test(first)) {
              if (!isNaN(first)) {
                verify.find('.jschange').stop(true).slideUp(200).delay(250).siblings('.jsverify').fadeIn(200);
                if(!(/^1[34578][0-9]{9}$/.test(val))) {
                  parent.find('.pop-error').stop(true).fadeIn(200).text('请输入正确的手机号');
                }
                
              } else {
                verify.find('.jsverify').stop(true).slideUp(200).delay(250).siblings('.jschange').fadeIn(200);
              }
            } else {
        ...
        $('.jspoptemporary').click(function() {  
          $g_id = "<?php echo I('get.game_id');?>";
          $p_id = "<?php echo I('get.pid');?>";  
          $.ajax({
            type:'post',
            url:ykzhuceurl,
        ...
        $('.jspopforget').click(function() {
          ...
          setTimeout(function() {
            $('<div class="fgbox" style="display:none;"><a href="javascript:;" class="pop-arrow-left "></a><ul class="pop-tab pop-clear"><li class="active">找回密码</li></ul><div class="pop-pan"><form id="zhmm" action=""><div class="pop-content"><div class="pop-table"><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_phone.png" class="icon icon-user"></div><div class="pop-cell"><div class="pop-input"><input type="text" name="" class="txt account" placeholder="请输入手机号"></div><span class="pop-iconbox pop-clear"><i class="icon icon-del jsdel"></i></span></div></div><div class="pop-row"><div class="pop-cell"><img src="/Public/Mobile/images/login_code.png" class="icon icon-user"></div><div class="pop-cell verification"><div class="pop-input"><input type="text" id="verify" name="" class="txt" placeholder="请输入验证码"></div><span class="pop-iconbox pop-clear" id="verify"><div class="pop-table"><div class="pop-cell"><a href="javascript:;" class="pop-code smcode jsverify">获取验证码</a></div></div></span></div></div></div><div class="pop-error error">用户名不存在</div></div><div class="pop-butn-box"><input type="submit" class="butn fgbutn disabled jssubbutn" value="下一步"></div></form><p class="fgnotice">通过手机号找回密码只适用于已绑定手机号的账户，为绑定手机号账户可<a href="<?php echo U("Subscriber/user_contact");?>" class="contact_service">联系客服<img src="/Public/Mobile/images/login_pop_btn_service.png"></a></p></div></div>').appendTo(popplog.find('.pop-box')).fadeIn(200);
