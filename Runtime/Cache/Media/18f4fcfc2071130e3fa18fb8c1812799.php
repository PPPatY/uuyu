...
<link href="/Public/Media/css/suspension.css" rel="stylesheet" >
  ...
  <div class="pc-game-box ">
    ...
    <iframe id="op_url_mainframe" src="<?php echo ($login_url); ?>" style="background:url(<?php echo ($game_load_page); ?>) center center no-repeat;" frameborder="0" class="gamestartbox hidden"></iframe>
