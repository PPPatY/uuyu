      ...
      <div class="wrap">
        <div class="sus-menu">
          ...
          <?php $HTTP_REFERER = $_SERVER['HTTP_REFERER']==''?U('Index/index'):$_SERVER['HTTP_REFERER']; ?>  
					<a href="<?php echo ($HTTP_REFERER); ?>" class="sus-menu-quit">退出</a>
					</div>
        </div>
        <div class="user-info clearfix">
          <div class="iconbox"><img src="/Public/Media/images/fq/invitate_img_head.png" class="portrait"></div>
          <div class="butnbox">
            <div class="table">
        ...
        <div class="user-other">
          ...
          <div class="pan jsstabpan">
                      ...
                      <div id="play-slide" class="swiper-container">
                          ...
                          <?php if(is_array($userPlay)): $i = 0; $__LIST__ = $userPlay;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$up): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
                                <div class="item">
                                  ...
                                  <a href="<?php echo ($up["play_url"]); ?>" class="butn"><span class="table"><span class="table-cell">开始</span></span></a>
                                </div>
                ...
                <div class="game-hot game-list">
                  ...
                  <div class="game-content">
                    ...
                    <div class="empty hidden">
                      <img src="/Public/Media/images/no_date.png" class="empty-icon">
            ...
            <div class="panitemservice">
              <div class="qq"><a href="javascript:;" data-value="<?php echo ($kefuqq); ?>" class="butn jschatqq"><img src="/Public/Media/images/invitate_service_qq.png" class="icon-qq"><span>客服：<?php echo ($kefuqq); ?><img src="/Public/Media/images/invitate_service_more.png" class="icon-arrow-right"></span></a></div>
              <div class="qrcode">
  ...
  <script>
    ...
    $(function() {
      ...
      var s = document.getElementById('jssuspensionbtn');
			...
			if (s.attachEvent) {console.log(os);
            ...
            if (hash === '') {
              $.ajax({
                ...
                success:function(data){
                  ...
                  result+='/Public/Media/images/Today-recommendation-game.png';
                  result+='"><p style="font-size:.5rem;color:#ff7777;">点击立即进入游戏</p></div><div class="partir-recommend"><ul class="pop-clear">';
                  ...
                  result+='<li><a href="<?php echo U("Game/index");?>"><img src="/Public/Media/images/pop_leave_logo.png"><p>更多游戏</p></a></li></ul></div></div><div class="butn100 pop-butn-box pop-clear">';
              ...
              $.ajax({
                  ...
                  success: function(data){
                      if(data.code==1){
                        ...
                        pop.addClass('pop-hint').open('','<a href="javascript:;" class="pop-close"></a><div class="pop-content"><img class="pop-image" src="/Public/Media/images/pop_receive_successful.png"><div class="pop-title">领取成功！</div><div class="pop-code pop-table"><span class="pop-cell pop-input"><input type="text" readonly class="code pop-txt" value="'+data.nvalue+'"></span></div><p class="pop-text">可在[我的礼包]中查看</p><a href="javascript:;" class="copy pop-btn">复制激活码</a></div>');
                        ...
                        pop.find('.copy').click(function() {
                            ...
                            Copy($('.code').val(),$('.pop-hint .pop-btn'));
														pop.close(400);
														setTimeout(function(){
															pop.open().addClass('pop-message').msg('<img class="pop-image" src="/Public/Media/images/pop_completed.png"><p class="pop-text">已复制</p>',1000,250);
														},440);
                          });
                      }else{
                        // 失败
                        pop.addClass('pop-hint').open('','<a href="javascript:;" class="pop-close"></a><div class="pop-content"><img class="pop-image" src="/Public/Media/images/pop_receive_fail.png"><div class="pop-title">领取失败！</div><p class="pop-text">'+data.msg+'</p></div>');
        ...
        if ($user) {
          $.ajax({
              ...
              success: function(data){
                  if(data.code==1){
                    if(data.data==1){
                        pop.addClass('pop-message').msg('<img class="pop-image" src="/Public/Media/images/pop_completed.png"><p class="pop-text">已收藏</p>',1000,250);
                        that.addClass('on').find('span').text('已收藏');
                        that.attr('data-collec',1)
                    }else{
                        pop.addClass('pop-message').msg('<img class="pop-image" src="/Public/Media/images/pop_completed.png"><p class="pop-text">收藏已取消</p>',1000,250);
    ...
    var dropload = $('.game-content').dropload({
          ...
          loadDownFn : function(me){
              ...
              if(itemIndex == '0'){
                  ...
                  if(data.status==0){
                    if(counter==1){
                      result +='<div class="empty swiper-categroy"><img src="/Public/Media/images/no_date.png" class="empty-icon"><p class="empty-text">~ 空空如也 ~</p></div>';
                    }
              ...
              // 加载菜单二的数据
                  ...
                  var result2 = '';
                  if(detail.status==0){
                      result1 +='<div class="empty swiper-categroy" style="height:auto;"><img src="/Public/Media/images/no_date.png" class="empty-icon"><p class="empty-text">~ 空空如也 ~</p></div>';
                  ...
                  if(other.status==0){
                      result2 +='<div class="empty swiper-categroy" style="height:auto;"><img src="/Public/Media/images/no_date.png" class="empty-icon"><p class="empty-text">~ 空空如也 ~</p></div>';
