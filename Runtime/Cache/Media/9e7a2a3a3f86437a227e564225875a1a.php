                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper tabpanel">
                      <div class="swiper-slide">
                        <div class="text-show">
                          <p class="name">账户积分</p>
                          <p class="number"><?php echo $userinfo['shop_point']>0?$userinfo['shop_point']:0;;?></p>
                          <div class="butnbox">
                            <a href="<?php echo U('PointShop/mall_integral',array('from'=>balance));?>" class="butn gain">获取</a>
                            <a href="<?php echo U('PointShop/mall');?>" class="butn defray">兑换</a>
                          </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="text-show">
                          ...
                          <p class="number"><?php echo $userinfo['balance']>0?$userinfo['balance']:0;;?></p>
                          <div class="butnbox">
                            <a href="<?php echo U('user_recharge');?>" class="butn gain">充值</a>
                          </div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                      <?php if(empty($binddata)): ?><div class="empty">
                          <img src="/Public/Media/images/blank_bind.png" class="empty-icon">
                          <p class="empty-text">暂无绑定平台币</p>
                        </div>
                      <?php else: ?>
                        <ul class="list text-pic-list">
                        <?php if(is_array($binddata)): $i = 0; $__LIST__ = $binddata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bd): $mod = ($i % 2 );++$i;?><li class="clearfix">
                            <div class="item clearfix">
                              <a href="<?php echo ($bd["play_detail_url"]); ?>" class="iconbox"><span class="font table"><span class="table-cell"><?php echo C('BITMAP');?></span></span><img src="<?php echo ($bd['icon']); ?>" class="icon"></a>
                              <div class="butnbox"><span class="table"><span class="table-cell"><?php echo ($bd['bind_balance']); ?></span></span></div>
                              <div class="text">
                                <div class="title"><?php echo ($bd['game_name']); ?></div>
                              </div>
                            </div>
