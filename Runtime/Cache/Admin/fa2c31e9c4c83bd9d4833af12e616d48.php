                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td class="r table_time">
                        <input type="text" class="txtt time" name="start_time" value="<?php echo date('Y-m-d H:i',time());?>" placeholder="输入开启时间 不能空"> 至
                  ...
                  <tr>
                    ...
                    <td class="r" colspan='3'>
                        <textarea name="digest" class="txt_area1" placeholder="输入领取方式描述"></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td class="l">礼包内容：</td>
