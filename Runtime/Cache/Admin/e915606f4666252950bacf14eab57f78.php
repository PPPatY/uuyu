...
<style type="text/css">
	...
	<div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="<?php echo U('Config/group');?>">管理后台</a></li>
            <li><a href="#">基本配置</a></li>
        </ul>
    </div>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i;?><li>
            ...
            <?php switch($config["type"]): case "0": ?><input type="text" class="" name="config[<?php echo ($config["name"]); ?>]" value="<?php echo ($config["value"]); ?>"><?php break;?>
			<?php case "1": ?><input type="text" class="" name="config[<?php echo ($config["name"]); ?>]" value="<?php echo ($config["value"]); ?>"><?php break;?>
			...
			<?php case "4": ?><select name="config[<?php echo ($config["name"]); ?>]" class="select_gallery select2-search--hide">
