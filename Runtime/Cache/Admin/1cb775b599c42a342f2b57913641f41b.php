...
<!--下拉样式结束-->
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="<?php echo U('Site/media');?>">双官网</a></li>
	...
	<div class="cf top_nav_list">
		<div class="fl button_list">
            <a class="" href="<?php echo U('add','pid='.$pid);?>"><span class="button_icon button_icon1"></span>新 增</a>
		...
		<table style="text-align:center">
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo get_kefu_lists(false,$channel['titleurl']);?></td>
						<td><?php echo ($channel['titleurl']); ?></td>
						<td><?php echo ($channel["zititle"]); ?></td>
						<td><?php echo ($channel["id"]); ?></td>
						<!--<td style="max-width:900px;width:900px;white-space:nowrap;overflow:hidden;text-overflow: ellipsis" title="<?php echo ($channel["contend"]); ?>"><?php echo ($channel["contend"]); ?></td>-->
						<td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Kefu/index');?>');
    $(function() {
    	//点击排序
