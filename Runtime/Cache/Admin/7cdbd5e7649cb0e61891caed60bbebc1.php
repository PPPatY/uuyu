...
<!--下拉样式结束-->
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            <li><a href="<?php echo U('Spend/lists');?>">站点</a></li>
            <li><a href="<?php echo U('PointType/lists');?>">积分商城</a></li>
	...
	<div class="cf top_nav_list">
		<div class="fl button_list">
            <?php if(empty($model["extend"])): ?><div class="tools">
                    ...
                    <a class=" ajax-post confirm " target-form="ids" url="<?php echo U('delete');?>"><span class="button_icon button_icon2"></span>删 除</a>
                </div><?php endif; ?>
		</div>
		<!-- 高级搜索 -->
            ...
            <table>
                ...
                <?php else: ?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo get_info_status($vo['good_type'],27);?></td>
                            <td><?php echo ($vo["number"]); ?></td>
                            <td><?php echo get_info_status($vo['status'],26);?></td>
                            <td>
                            <a href="<?php echo U('edit',array('id'=>$vo['id']));?>">编辑</a>
                            <a class="ajax-get confirm" href="<?php echo U('delete',array('ids'=>$vo['id']));?>">删除</a>
                            </td>
...
$(function(){
    Think.setValue('status_show',"<?php echo I('status_show');?>");
	//搜索功能
