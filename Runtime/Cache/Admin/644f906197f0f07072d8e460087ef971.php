...
<script type="text/javascript" src="/Public/static/uploadify/jquery.uploadify.min.js"></script>
	<div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="<?php echo U('Site/app');?>">联运APP</a></li>
            <li><a href="#">基本配置</a></li>
        </ul>
        <p class="description_text" style="height: 40px;line-height: 40px;">说明：针对联运APP的基本信息进行配置</p>
    </div>
    <div class="cf main-place top_nav_list navtab_list">
        <?php echo W('Index/navigation',array('value'=>'Site/app'));?>
    </div>
    <div class="tab-wrap tab-list">
		<div class="tab_nav jstabnav">
    <ul>
    	<?php if(is_array(C("APP_CONFIG_GROUP_LIST"))): $i = 0; $__LIST__ = C("APP_CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><li <?php if(($id) == $key): ?>class="current"<?php endif; ?>><a href="<?php echo U('app',array(cate_id=>I('cate_id'),group_id=>$key));?>"><?php echo ($group); ?>配置</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul></div>
		<div class="tab-content tab_content">
	<form action="<?php echo U('save');?>" method="post" class="form-horizontal">
	<ul class="form_info form_info<?php echo I('group_id',1)+20;?>">
...
<script type="text/javascript">
	//导航高亮
	highlight_subnav('<?php echo U('Site/app');?>');
</script>
