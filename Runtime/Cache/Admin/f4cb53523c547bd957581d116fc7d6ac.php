  ...
  <style>
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="<?php echo U('Provide/bdfirstpay');?>">绑币订单</a></li>
            <li><a href="#"><?php echo ($meta_title); ?></a></li>
        </ul>
      
    </div>
    <div class="cf top_nav_list navtab_list navlist_copy"> 
        <a <?php if(ACTION_NAME == 'bdfirstpay'): ?>class="tabchose"<?php endif; ?> href="<?php echo U('Provide/bdfirstpay');?>">给玩家发放</a>
        <a <?php if(ACTION_NAME == 'lists'): ?>class="tabchose"<?php endif; ?> href="<?php echo U('Provide/lists');?>">玩家发放记录</a>
        <?php if(ACTION_NAME == 'bdfirstpay'): ?><p class="description_text" style="margin-top: 14px;">说明：此功能是为给玩家发放绑定平台币功能</p><?php endif; ?>
    </div>
    <!-- 标签页导航 -->
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
          <ul>
            ...
            <li data-tab="tab2" ><a href="javascript:void(0);">批量发放</a></li>
          </ul>
      </div>
       <div class="tab-content tab_content">
        <!-- 表单 -->
          ...
          <form id="form1" action="<?php echo U('bdfirstpay');?>" method="post" class="form-horizontal">
          ...
          <form id="form2" action="<?php echo U('bdfirstpay');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
          ...
          <form id="form3" action="<?php echo U('bdfirstpay');?>" method="post" class="form-horizontal">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
...
<script type="text/javascript">
    //导航高亮
    highlight_subnav('<?php echo U('Provide/bfirstpay');?>');
