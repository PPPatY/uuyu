...
<!--下拉样式结束-->
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="#">批量导入 [<?php echo ((isset($data["title"]) && ($data["title"] !== ""))?($data["title"]):'顶级菜单'); ?>]</a></li>
        </ul>
    </div>
	...
	<!-- 标签页导航 -->
<div class="tab-wrap">
	<div class="formtitle" style="margin-bottom: 0;"><span>批量导入 [顶级菜单]</span></div>
	<div class="tab-content tab_content">
	<!-- 表单 -->
	<form id="form" action="<?php echo U('import');?>" method="post" class="form-horizontal" style="margin-left: 50px;">
		...
		<div id="tab1" class="tab-pane in tab1">
			<div class="form-item cf">
				...
				<div class="controls table_textarea">
						<textarea name="tree" style="width: 310px;"></textarea>
				</div>
				<span class="check-tips">导入格式：标题|url(回车键)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标题|url</span>
			</div>
		</div>
		<div class="form-item cf">
			<button class=" submit_btn ajax-post " id="submit" type="submit" target-form="form-horizontal" style="margin-left: 0;margin-top: 20px;">确 定</button>
			<button class="back_btn" type="button" onclick="window.location.href=&#39;<?php echo U('index?pid='.$pid);?>&#39;">返 回</button>
