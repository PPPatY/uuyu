                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li>
                            ...
                            <a href="?s=/Wechat/addSucai.html">
                                <input type="button" value="添加" class=""style="padding:5px 20px; margin-left:430px;" >
                            </a>
                        </li>
