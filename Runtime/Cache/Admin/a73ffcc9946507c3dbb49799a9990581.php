...
<!--下拉样式结束-->
    ...
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
            <ul>
                <li data-tab="tab1" class="current firsttab"><a href="javascript:void(0);" >事件消息列表</a></li>
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li>
                            ...
                            <a href="<?php echo U('Wxoperate/addEvent');?>">
                        ...
                        <table border="1" class="table-list" style="margin-left: 50px">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$eventData): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($eventData["id"]); ?></td>
                                    <td><img class="js-showimg-url-p" data="<?php echo ($eventData["picurl"]); ?>" src="<?php echo ($eventData["picurl"]); ?>"></td>
                                    <td title="<?php echo ($eventData["url"]); ?>"><?php echo ($eventData["url"]); ?></td>
                                    <td title="<?php echo ($eventData["description"]); ?>"><?php echo ($eventData["description"]); ?></td>
                                    <td>
                                        <?php if($eventData["type"] == '0'): ?>否
                                            <?php else: ?>
                                            是<?php endif; ?>
                                    </td>
                                    <td>
                                        <a href="javascript:;" class="js-delete" id="<?php echo ($eventData["id"]); ?>">删除</a>
                                        <a href="?s=/Wxoperate/editEvent/id/<?php echo ($eventData["id"]); ?>">编辑</a>
                                    </td>
    ...
    <script>
        ...
        function sendDatas(e, t){
            ...
            var data_v = e;
            var sendData = $.ajax({
                url: "<?php echo U('Wxoperate/delEvent');?>",
                method: 'post',
                data: data_v,
                dataType: 'json'
            })
