...
<!--下拉样式结束-->
    ...
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
            <ul>
                <li data-tab="tab1" class="current firsttab"><a href="javascript:void(0);" >图片素材</a></li>
            </ul>
        </div>
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li>
                            ...
                            <a href="<?php echo U('Wxoperate/upMeterial');?>">
                        ...
                        <table border="1" class="table-list" style="margin-left: 50px">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$meteData): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($meteData["id"]); ?></td>
                                    <td title="<?php echo ($meteData["media_id"]); ?>"><?php echo ($meteData["media_id"]); ?></td>
                                    <td title="<?php echo ($meteData["url"]); ?>"><?php echo ($meteData["url"]); ?></td>
                                    <td><?php echo ($meteData["type"]); ?></td>
                                    <td title="<?php echo ($meteData["mark"]); ?>"><?php echo ($meteData["mark"]); ?></td>
                                    <td>
                                        <a href="javascript:;" class="js-delete" id="<?php echo ($meteData["id"]); ?>">删除</a>
                                    </td>
    ...
    <script>
        ...
        function sendDatas(e){
            ...
            var data_v = e;
            var sendData = $.ajax({
                url: "<?php echo U('Wxoperate/delMeterial');?>",
                method: 'post',
                data: data_v,
                dataType: 'json'
            })
        ...
        function DialogErrorTip(e){
            ...
            if(e == 1){
                setTimeout(function(){
                    errorTipP.hide();
                    window.location.href = "<?php echo U('Wxoperate/metelist');?>";
                },1500);
