...
<style type="text/css">
    ...
    <form id="form" action="<?php echo U('edit?model='.$model['id']);?>" method="post" class="form-horizontal form_info_ml">
            ...
            <li><label>显示状态：</label>
            	<span class="table_radio">
            		<div class="radio radio-primary">
						<input type="radio" id="radio1" value="0" name="status_show" <?php if(($data['status_show']) == "0"): ?>checked="checked"<?php endif; ?>>
						<label for="radio1">关闭</label>
					</div>
					<div class="radio radio-primary">
						<input type="radio" id="radio2" value="1" name="status_show" <?php if(($data['status_show']) == "1"): ?>checked="checked"<?php endif; ?>>
