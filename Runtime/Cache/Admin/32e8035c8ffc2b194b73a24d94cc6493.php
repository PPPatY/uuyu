...
<script type="text/javascript" src="/Public/Admin/js/select2.min.js"></script>
	...
	<div class="cf top_nav_list">
		...
		<div class="jssearch fr cf search_list">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Giftbag/record');?>">搜索</a>
            </div>
		</div>
	</div>
    ...
    <div class="data_list">
        <div class="">
            <table>
                ...
                <!-- 列表 -->
                <tbody>
                    <?php if(empty($list_data)): ?><tr><td colspan="5">暂无数据</td></tr>
                    <?php else: ?>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Giftbag/record');?>');
$(function(){
	//搜索功能
