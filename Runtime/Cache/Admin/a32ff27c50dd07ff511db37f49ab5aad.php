    ...
    <div class="tab-wrap">
        ...
        <div class="keyword-wrap">
            <div class="content">
                <div class="keyword li-com" >
                    ...
                    <input type="text" class="EventKey-p" data="<?php echo ($info["id"]); ?>" value="<?php echo ($info["eventkey"]); ?>">
                </div>
                <div class="reply li-com">
                    <span class="key-text">回复：</span>
                    <?php if($info["msgtype"] == '0'): ?><label for="for-text" class="for-text js-change-reply"><input id="for-text" type="radio" value="1" name="reply-chose" checked="checked">文本</label>
                        ...
                        <?php else: ?>
                            <label for="for-text" class="for-text js-change-reply"><input id="for-text" type="radio" value="1" name="reply-chose">文本</label>
                            <label for="for-lianjie" class="for-lianjie js-change-reply"><input id="for-lianjie" type="radio" value="0" name="reply-chose">链接</label>
                            <label for="for-tuwen" class="for-tuwen js-change-reply"><input id="for-tuwen" type="radio" value="0" name="reply-chose" checked="checked">图文</label><?php endif; ?>

                    <div class="text-content show-content active">
                        <textarea id="editor-w" placeholder="<?php echo ($info["msgcontent"]); ?>"></textarea>
                    </div>
                    <div class="lianjie-content show-content">
                        <div class="keyword li-com" style="margin-left: -50px;">
                            ...
                            <input type="text" class="item-url-p" value="<?php echo ($info["msgcontent"]); ?>">
                        </div>
                    </div>
                    <div class="tuwen-content show-content">
                        <div class="keyword li-com" style="margin-left: -50px;">
                            <span class="key-text">item：</span>
                            <input type="text" class="item-id-p" value="<?php echo ($info["msgcontent"]); ?>">
        ...
        <script>
            ...
            $(document).ready(function () {
               var _show = "<?php echo ($info["msgtype"]); ?>" ;
               if(_show == 0) {
                   $('.text-content').show();
            ...
            function sendDatas(e){
                ...
                var data_v = e;
                var sendData = $.ajax({
                    url: "<?php echo U('Wxoperate/editNavEvent');?>",
                    method: 'post',
                    data: data_v,
                    dataType: 'json'
                });
            ...
            function DialogErrorTip(e){
                ...
                if(e == 1){
                    setTimeout(function(){
                        errorTipP.hide();
                        window.location.href = "<?php echo U('Wxoperate/navEventList');?>";
                    },1500);
