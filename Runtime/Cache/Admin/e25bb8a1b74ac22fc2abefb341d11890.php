...
<!--下拉样式结束-->
    ...
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
            <ul>
                <li data-tab="tab1" class="current firsttab"><a href="javascript:void(0);" >菜单导航事件列表</a></li>
            </ul>
        </div>
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li>
                            ...
                            <a href="<?php echo U('Wxoperate/addNavEvent');?>">
                        ...
                        <table border="1" class="table-list" style="margin-left: 50px">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$eventData): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td title="<?php echo ($eventData["eventkey"]); ?>"><?php echo ($eventData["eventkey"]); ?></td>
                                    <td><?php echo ($eventData["msgtype"]); ?></td>
                                    <td title="<?php echo ($eventData["msgcontent"]); ?>"><?php echo ($eventData["msgcontent"]); ?></td>
                                    <td>
                                        <a href="javascript:;" class="js-delete" id="<?php echo ($eventData["id"]); ?>" style="margin-right: 15px;">删除</a>
                                        <a href="?s=/Wxoperate/editNavEvent/id/<?php echo ($eventData["id"]); ?>">编辑</a>
                                    </td>
    ...
    <script>
        ...
        function sendDatas(e,t){
            ...
            var data_v = e;
            var sendData = $.ajax({
                url: "<?php echo U('Wxoperate/delNavEvent');?>",
                method: 'post',
                data: data_v,
                dataType: 'json'
            })
