...
<!--下拉样式结束-->
    ...
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
            <ul>
                <li data-tab="tab1" class="current firsttab"><a href="javascript:void(0);" >素材</a></li>
                ...
                <div class="reply li-com">
                    <div class="tuwen-content show-content active">
                        <div class="bg-pic li-com">
                            ...
                            <input type="text" class="meterial-title-p" data="<?php echo ($con["id"]); ?>" value="<?php echo ($con["title"]); ?>">
                            <i style="font-style: normal;color: #ff2020; margin-left: 30px;"> </i>
                        </div>
                        <div class="bg-pic li-com">
                            <span class="key-text">素材缩略图：</span>
                            <input type="text" class="meterial-media-p" value="<?php echo ($con["thumb_media_id"]); ?>">
                            <i style="font-style: normal;color: #ff2020; margin-left: 30px;"></i>
                        </div>
                        <div class="bg-pic li-com">
                            <span class="key-text">作者：</span>
                            <input type="text" class="meterial-auther-p" value="<?php echo ($con["author"]); ?>">
                            <i style="font-style: normal;color: #ff2020; margin-left: 30px;"> </i>
                        </div>
                        <div class="bg-pic li-com">
                            <span class="key-text">摘要：</span>
                            <input type="text" class="meterial-digest-p" value="<?php echo ($con["digest"]); ?>">
                            <i style="font-style: normal;color: #ff2020; margin-left: 30px;"> </i>
                        </div>
                        <div class="bg-pic li-com">
                            <span class="key-text" style="margin-top: -3px;">封面：</span>
                            <?php if($con["show_cover_pic"] == '1'): ?><label for="for-tuwen" class="for-tuwen js-change-keyw">
                                    <input id="for-tuwen" type="radio" value="0" name="chose">否
                                </label>
                                <label for="for-text" class="for-text js-change-keyw">
                                    <input id="for-text" type="radio" value="1" name="chose" checked="checked">是
                                </label>
                            <?php else: ?>
                        ...
                        <div class="bg-pic li-com">
                            ...
                            <input type="text" class="meterial-url-p" value="<?php echo ($con["content_source_url"]); ?>">
                            <i style="font-style: normal;color: #ff2020; margin-left: 30px;"> </i>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#txtdiv').find('p').html("<?php echo ($con["content_source_url"]); ?>");
            });
            ...
            $('.js-submit').click(function () {
                ...
                data.id = $('.meterial-title-p').attr("data");
                ...
                data.content = data.content || editor.$txt.html();;
            ...
            function sendDatas(e){
                ...
                var data_v = e;
                var sendData = $.ajax({
                    url: "<?php echo U('Wxoperate/editnewsMeterial');?>",
                    method: 'post',
                    data: data_v,
                    dataType: 'json'
                });
            ...
            function DialogErrorTip(e){
                ...
                if(e == 1){
                    setTimeout(function(){
                        errorTip.hide();
                        window.location.href = "<?php echo U('Wxoperate/upnewslList');?>";
                    },1500);
