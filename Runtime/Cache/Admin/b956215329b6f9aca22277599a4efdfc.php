...
<!--下拉样式结束-->
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            ...
            <li><a href="<?php echo U('Model/index');?>">系统设置</a></li>
            <li><a href="#"><?php if(isset($data)): ?>[ <?php echo ($data["title"]); ?> ] 子<?php endif; ?>菜单管理</a></li>
        </ul>
    </div>
    
    <div class="cf top_nav_list">
		<div class="fl button_list">
            <a class="" href="<?php echo U('add',array('pid'=>I('get.pid',0)));?>"><span class="button_icon button_icon1"></span>新 增</a>
            <a class=" ajax-post confirm" url="<?php echo U('del');?>" target-form="ids"><span class="button_icon button_icon2"></span>删 除</a>
            <a class="" href="<?php echo U('import',array('pid'=>I('get.pid',0)));?>"><span class="button_icon button_icon24"></span>导 入</a>
            <a class=" list_sort" url="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>"><span class="button_icon button_icon18"></span>排序</a>
        </div>
        <!-- 高级搜索 -->
        <div class="jssearch fr cf search_list">
            <div class="input-list">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/admin.php?s=/Menu/index/pid/43.html">搜索</a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        <td>
                        	<label class="checked">
								<input class="ids" type="checkbox" name="id[]" value="<?php echo ($menu["id"]); ?>">
								<i class="check_icon"></i>
							</label>
                    	</td>
