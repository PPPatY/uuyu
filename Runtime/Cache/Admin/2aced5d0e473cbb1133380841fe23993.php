            ...
            <table  border="0" cellspacing="0" cellpadding="0" class="data_list">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <select id="game_type_id" name="game_type_id" class="select_gallery">
                            <option value="" <?php if(empty($data['game_type_id'])): ?>selected="selected"<?php endif; ?>>请选择游戏类型</option>
                  ...
                  <tr>
                    ...
                    <td class='r'>
                        <input type="text" class='txt' name='play_count' id="play_count" value="<?php echo play_num($data['id']);?>">
                        <label class="checked">
							<input type="checkbox" id="play_ok">
                  ...
                  <tr>
                  	<td class="l">游戏评分：</td>
                    <td class="r">
                        <input type="text" class="txt" name="game_score" value="<?php echo ($data['game_score']); ?>" placeholder="请输入0-10的数字">
                    </td>
                  </tr>
                  <tr>
                  	<td class="l">游戏开发商：</td>
                  ...
                  <tr>
                    ...
                    <td class="r" colspan="3">
                        <input type="text" class="txt txt_title" name="features" value="<?php echo ($data['features']); ?>">
                    </td>
                  </tr>
                  <tr>
                  	<td class="l">游戏属性：</td>
                    <td class="r table_radio">
                    	<div class="radio radio-primary">
							<input type="radio" id="radio1" class="inp_radio" value="1" name="game_attribute" <?php if(($data["game_attribute"]) == "1"): ?>checked<?php endif; ?>>
							<label for="radio1">网游</label>
						</div>
						<div class="radio radio-primary">
							<input type="radio" id="radio2" class="inp_radio" value="2" name="game_attribute" <?php if(($data["game_attribute"]) == "2"): ?>checked<?php endif; ?>>
                   ...
                   <tr>
                    ...
                    <td class="r table_radio">
                      <div class="radio radio-primary">
              <input type="radio" id="radio10" class="inp_radio" value="1" name="screen_type" <?php if(($data["screen_type"]) == "1"): ?>checked<?php endif; ?>>
              <label for="radio10">横屏</label>
            </div>
            <div class="radio radio-primary">
              <input type="radio" id="radio11" class="inp_radio" value="2" name="screen_type" <?php if(($data["screen_type"]) == "2"): ?>checked<?php endif; ?>>
                  ...
                  <tr>
                    ...
                    <td class="r table_radio">
                        <label class="inp_radio">
                        	<div class="radio radio-primary">
								<input type="radio" id="radio3" class="inp_radio" value="0" name="game_status" <?php if(($data['game_status']) == "0"): ?>checked="checked"<?php endif; ?>>
								<label for="radio3">关闭</label>
							</div>
							<div class="radio radio-primary">
								<input type="radio" id="radio4" class="inp_radio" value="1" name="game_status" <?php if(($data['game_status']) == "1"): ?>checked="checked"<?php endif; ?>>
								<label for="radio4">开启</label>
							</div>
                        </label>
                        <span class="notice-text" style="margin-left: 240px;">设置该游戏是否在各个站点显示</span>
                    </td>
                  </tr>
                    <tr>
                    <td class="l">测试状态：</td>
                    <td class="r table_radio">
                        <label class="inp_radio">
                          <div class="radio radio-primary">
                <input type="radio" id="radio13" class="inp_radio" value="0" name="test_status" <?php if(($data['test_status']) == "0"): ?>checked="checked"<?php endif; ?>>
                <label for="radio13">测试中</label>
              </div>
              <div class="radio radio-primary">
                <input type="radio" id="radio14" class="inp_radio" value="1" name="test_status" <?php if(($data['test_status']) == "1"): ?>checked="checked"<?php endif; ?>>
                <label for="radio14">正常</label>
              </div>
                        </label>
                        <span class="notice-text" style="margin-left: 240px;">设置该游戏是否测试中,测试中不显示在列表中，但可以进入游戏</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="l">运营状态：</td>
                    <td class="r table_radio">
                        <label class="inp_radio">
                        	    <div class="radio radio-primary">
								    <input type="radio" id="radio5" class="inp_radio" value="0" name="category" <?php if(($data["category"]) == "0"): ?>checked="ture"<?php endif; ?>>
								    <label for="radio5">不限</label>
							    </div>
					    	<?php $_result=get_opentype_all();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="radio radio-primary">
								    <input type="radio" id="radio_<?php echo ($vo["id"]); ?>" class="inp_radio" value="<?php echo ($vo["id"]); ?>" name="category" <?php if(($data["category"]) == $vo['id']): ?>checked<?php endif; ?> >
                  ...
                  <tr>
                    <td class="l">推荐状态：</td>
                    <td class="r table_radio">
								<input type="checkbox" id="radio6" class="inp_radio" value="0" name="recommend_status[]" <?php if(in_array(0,$data['recommend_status'])): ?>checked="checked"<?php endif; ?>>
								<label for="radio6">不推荐</label>
								<input type="checkbox" id="radio7" class="inp_radio" value="1" name="recommend_status[]" <?php if(in_array(1,$data['recommend_status'])): ?>checked="checked"<?php endif; ?>>
								<label for="radio7">推荐</label>
								<input type="checkbox" id="radio8" class="inp_radio" value="2" name="recommend_status[]" <?php if(in_array(2,$data['recommend_status'])): ?>checked="checked"<?php endif; ?>>
								<label for="radio8">热门</label>
								<input type="checkbox" id="radio9" class="inp_radio" value="3" name="recommend_status[]" <?php if(in_array(3,$data['recommend_status'])): ?>checked="checked"<?php endif; ?>>
								<label for="radio9">最新</label>
                        <span class="notice-text" style="margin-left: 81px;">设置游戏的推荐类型，更改此游戏在网站所属的推荐板块；</span>
                    </td>
                  </tr>
                  <tr class="picbox">
                        ...
                        <span class="notice-text" style="margin-left: 274px;">上传该游戏的图标</span>
                        </td>
                	</tr>
                	<tr class="picbox">
                		<td class="l">游戏推荐图：<span class="infonotice2">(尺寸：277*176px)</span> </td>
                    <td class="r">
                    <?php echo hook('UploadImages', array('name'=>'cover','value'=>$data['cover'],'pic_num'=>1));?>
                        <span class="notice-text" style="margin-left: 274px;">当该游戏设置到推荐位时，需要此处上传相关尺寸的游戏封面图</span>
                    </td>
                	</tr>
                	<tr class="picbox">
                		<td class="l">游戏截图：<span class="infonotice2">(尺寸：277*176)</span> </td>
                      <td class="r" >
                	...
                	<tr class="picbox">
                      ...
                      <td class="r" >
                    	<?php echo hook('UploadImages', array('name'=>'game_load_page','value'=>$data['game_load_page'],'pic_num'=>1));?>
                        <span class="notice-text" style="margin-left: 274px;">上传闪屏信息</span>
                    </td>
                  </tr>
                   <tr>
                    <td class="l">详细介绍：</td>
                    <td class="r" colspan='3'>
                        <textarea name="introduction" class="txt_area"><?php echo str_replace("~~","\r\n",$data['introduction']);?></textarea>
                    </td>
                   </tr>
                </tbody>
            </table>
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt" name="ratio" value="<?php echo $data['ratio'];?>" placeholder="输入0-100之间的数字"> %
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt" name="money" value="<?php echo ($data['money']); ?>" placeholder="请输入不小于0的数值"> 元
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt" name="discount" value="<?php echo ($data['discount']); ?>" placeholder="输入1-10之间的数字"> 折
                        <span class="notice-text">设置该游戏的统一折扣，推广员后台会长代充时使用</span>
                    </td></tr>
                    <tr>
                    <td class="l">第三方游戏地址：</td>
                    <td class="r">
                        <input type="text" class="txt txt_title" name="third_party_url" value="<?php echo ($data['third_party_url']); ?>" placeholder="输入三方游戏链接">
                   ...
                   <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt txt_title" name="and_dow_address" value="<?php echo ($data['and_dow_address']); ?>" placeholder="输入安卓微端地址">
                   ...
                   <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt txt_title" name="ios_dow_address" value="<?php echo ($data['ios_dow_address']); ?>" placeholder="输入苹果微端地址">
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt txt_title" name="login_notify_url" value="<?php echo ($data['login_notify_url']); ?>" placeholder="输入游戏登录通知地址">
                        <span class="notice-text">此处功能为平台用户游戏登录时，通知CP方所用，该地址由CP方提供</span>
                    </td>
                  </tr>
                  <tr>
                  	<td class="l">游戏支付通知地址：</td>
                    <td class="r">
                        <input type="text" class="txt txt_title" name="pay_notify_url" value="<?php echo ($data['pay_notify_url']); ?>" placeholder="支付时通知CP方所用的地址">
                  ...
                  <tr>
                    <td class="l">游戏key：</td>
                    <td class="r">
                        <input type="text" class="txt" name="game_key" value="<?php echo ($data['game_key']); ?>" placeholder="输入游戏key">
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt" name="game_pay_appid" value="<?php echo ($data['game_appid']); ?>" placeholder="游戏支付时用的的AppId">
...
Think.setValue("game_type_id", <?php echo ((isset($data["game_type_id"]) && ($data["game_type_id"] !== ""))?($data["game_type_id"]): ''); ?>);
