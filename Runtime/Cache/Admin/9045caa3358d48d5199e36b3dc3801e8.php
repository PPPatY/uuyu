...
<!--下拉样式结束-->
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li style="padding-left: 110px;">
                            <label class="js-showimg-url-p" data="<?php echo ($info["picurl"]); ?>" style="position: absolute; left: -20px;">上传图片素材：</label> <i class="note-shuoming">图片支持 JPG, PNG, JPEG </i>
                            <?php echo hook('UploadImages', array('name'=>'showNewSucai','value'=>$info['picurl'],'pic_num'=>1));?>
                        </li>
                    </ul>

                    <div class="keyword li-com">
                        <span class="key-text">标题：</span>
                        <input type="text" class="event-tit-p" value="<?php echo ($info["title"]); ?>" data="<?php echo ($info["id"]); ?>" style="padding: 3px 6px; border:1px solid #999;">
                    </div>
                    ...
                    <div class="bg-pic li-com">
                        ...
                        <textarea id="editor-w" value="<?php echo ($info["description"]); ?>" style="border:1px solid gray;min-height:240px;max-width: 600px;"><?php echo ($info["description"]); ?></textarea>
                    </div>
                    <div class="keyword li-com">
    ...
    <script>
        ...
        $('.js-submit-menuSettings').click(function () {
            ...
            data.picurl = $('.upload-img-box .upload-pre-item img')[0].src || null;
        ...
        function sendDatas(e){
            ...
            var data_v = e;
            var sendData = $.ajax({
                url: "<?php echo U('Wxoperate/editEvent');?>",
                method: 'post',
                data: data_v,
                dataType: 'json'
            });
