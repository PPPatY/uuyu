...
<!--下拉样式结束-->
    ...
    <div class="tab-wrap">
        <div class="tab_nav jstabnav">
            <ul>
                <li data-tab="tab1" class="current firsttab"><a href="javascript:void(0);" >消息内图片</a></li>
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <ul class="form_info ">
                        <li>
                            ...
                            <a href="<?php echo U('Wxoperate/upImgUrl');?>">
                        ...
                        <table border="1" class="table-list" style="margin-left: 50px">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$listsData): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($listsData["id"]); ?></td>
                                    <td><img src="<?php echo ($listsData["url"]); ?>"></td>
                                    <td title="<?php echo ($listsData["url"]); ?>"><?php echo ($listsData["url"]); ?></td>
                                    <td title="<?php echo ($listsData["description"]); ?>"><?php echo ($listsData["description"]); ?></td>
                                    <td>
                                        <a href="javascript:;" class="js-delete" id="<?php echo ($listsData["id"]); ?>">删除</a>
                                        <!--<a href="?s=/Wxoperate/material/id/<?php echo ($listsData["id"]); ?>">编辑</a>-->
                                    </td>
    ...
    <script>
        ...
        function sendDatas(e){
            ...
            var data_v = e;
            var sendData = $.ajax({
                url: "<?php echo U('Wxoperate/urlLists');?>",
                method: 'post',
                data: data_v,
                dataType: 'json'
            })
