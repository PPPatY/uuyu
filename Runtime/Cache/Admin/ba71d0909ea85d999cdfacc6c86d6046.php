...
<!--下拉样式结束-->
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function () {
            UE.getEditor('ps_goods_info', {
                ...
                serverUrl: "<?php echo U(MODULE_NAME.'/PointShop/save_info');?>"
            });
        });
    </script>
    ...
    <div class="main-place">
        ...
        <ul class="main-placeul">
            <li><a href="<?php echo U('Site/config_index');?>">站点</a></li>
            <li><a href="<?php echo U('lists');?>">积分商城</a></li>
            <li><a href="<?php echo U('lists');?>"><?php echo ($meta_title); ?></a></li>
        </ul>
    </div>
    <!-- 标签页导航 -->
    <div class="tab-wrap">
                    ...
                    <table  border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="r" colspan='1'>
                                ...
                                <div class="upload-img-box">
                                    <?php if(!empty($data['detail_cover'])): ?><div class="upload-pre-item"><img src="<?php echo get_cover($data['detail_cover'],'path');?>"/></div><?php endif; ?>
                                </div>
                        ...
                        <tr>
                            <td class="l">商品详情：</td>
                            <td class="r">
                                <textarea name="good_info" id="ps_goods_info" style="width:800px;height:260px;"><?php echo ($data['good_info']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="l">状态：</td>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            Think.setValue("good_type","<?php echo ($data["good_type"]); ?>");
            Think.setValue("status","<?php echo ($data["status"]); ?>");
            good_type();
