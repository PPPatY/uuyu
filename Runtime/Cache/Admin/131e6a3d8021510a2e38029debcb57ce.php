            ...
            <form action="<?php echo U('saveTool');?>" class="form-horizontal qq_login form_info_ml">
                <div id="tab1" class="tab-pane in tab1">
                    ...
                    <div class="keyword li-com">
                        ...
                        <input type="text" class="event-tit-p" value="" style="padding: 3px 6px; border:1px solid #999;">
                    </div>
                    ...
                    <div class="keyword li-com">
                        ...
                        <input type="text" class="event-url-p" value="" style="padding: 3px 6px; border:1px solid #999;width: auto; min-width: 200px;">
                    </div>
                    <div class="form-item">
