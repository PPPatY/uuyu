...
class WxHongBaoHelper
{
	...
	var $partnerkey; /* 微信支付商户平台 API密钥 */
	
	/**
	 * 构造函数
	 * @param string $partnerkey 微信支付商户平台 API密钥
	 */
	function __construct($partnerkey)
	{
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		//echo dirname(__FILE__).DIRECTORY_SEPARATOR.'cert'.DIRECTORY_SEPARATOR.'apiclient_cert.pem';
