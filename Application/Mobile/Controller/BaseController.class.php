...
class BaseController extends Controller {
	public function __construct() {
		...
		//排除自动登录方法
		$arr = array('user','verify','logout','login','wechat_login_game','register','iosdownload','isChineseName','isChineseName','isChineseNamereturn','isidcard','isidcardreturn','checkphoneexsite','checkaccount','telsvcode','check_tel_code','iosdownload');
        if (!in_array(strtolower(ACTION_NAME), $arr, true)) {
			$this->wechat_login();
		}
		parent::__construct();
