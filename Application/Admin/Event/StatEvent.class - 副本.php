...
class StatEvent extends Controller
{
    ...
    public function spend_statistics()
    {
        ...
        $order = "pay_way ASC";
        $map["pay_status"] = 1;
        $last_month_amount = $this->last_month_data($model_name, $serach_field, $field, $group, $order,$map);
        ...
        $this_month_amount = $this->this_month_data($model_name, $serach_field, $field, $group, $order,$map);
    ...
    public function register_statistics()
    {
        ...
        $map["lock_status"] = 1;
        $last_month1 = $this->last_month_data($model_name, $serach_field, $field, $group, $order,$map);
        ...
        $this_month1 = $this->this_month_data($model_name, $serach_field, $field, $group, $order,$map);
     ...
     * 上月数据
     */
    public function last_month_data($model_name, $serach_field, $field = true, $group = "", $order = "", $map = array())
    {
     ...
     * 本月数据
     */
    protected function this_month_data($model_name, $serach_field, $field = true, $group = "", $order = "",$map=array())
    {
